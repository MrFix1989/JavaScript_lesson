...
var myObject = { // помисо свойств в обьектах могут быть и методы
    name:'Ivan',
    sureName:'Ivanov',
    age: 35,
    getFullName: function () {
        return this.name + ' ' + this.sureName; //для того что бы обраться названию обекта внутри фенкции можно ипользовать ключевое слово this - обращаеться к текущему обЪекту
    }
};
